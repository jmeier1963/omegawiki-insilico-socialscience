...
## Methods (10 total)
- [other] AGI Dynamic General Equilibrium with VAT-Financed Targeted UBI
- [evaluation] Accepted-Paper Baseline Benchmarking
- [evaluation] AI Consciousness Test (ACT)
- [system] Automated AI Research Loop
- [system] GraphRAG
- [evaluation] Open-World Evaluations
- [data] Privacy-Preserving Usage Telemetry Classification
- [benchmark] Replica Figure-Replication Task Generation Pipeline
- [evaluation] Shadow Evaluation
- [training] Turn-Level Credit Assignment for Long-Horizon RL
## Open Gaps
...
- [paper/advancing-mathematics-research-ai-driven-formal] How does performance scale as base LLMs improve — will the basic agent event
...
- [2] First Steps Toward Automated AI Research — Recursive's automated AI research system, running a propose-implement-run-validate-choose-next loop over long horizons with reward-hack and variance checks, reaches state-of-the-art on three benchmarks: NanoChat Autoresearch (0.9109 BPB), NanoGPT Speedrun (77.5s), and SOL-ExecBench GPU kernels (0.754).
...
## Recent Relationships (916 total)
  papers/strategy-age-ai-eight-points-beyond --same_problem_as--> papers/us-vs-china-how-win-wrong
  papers/future-everyone-path-positive-ai-future --introduces_concept--> concepts/balance-of-power-ai-safety-paradigm
  papers/future-everyone-path-positive-ai-future --uses_concept--> concepts/silicon-valley-transhumanism
  papers/future-everyone-path-positive-ai-future --uses_concept--> concepts/cloud-capitalism-business-model
  papers/future-everyone-path-positive-ai-future --challenges--> papers/machines-loving-grace-how-ai-could
  papers/big-tech-big-problem --same_problem_as--> papers/future-everyone-path-positive-ai-future
  papers/future-everyone-path-positive-ai-future --same_problem_as--> papers/unholy-alliance-tech-moguls-populist-leaders
  papers/beyond-tomorrow-four-scenarios-world-2050 --uses_concept--> concepts/agentic-enterprise-operations
  papers/beyond-tomorrow-four-scenarios-world-2050 --extends_concept--> concepts/ai-product-channel
  papers/beyond-tomorrow-four-scena
