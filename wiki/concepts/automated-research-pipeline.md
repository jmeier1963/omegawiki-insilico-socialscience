...
- [[accepted-paper-baseline-benchmarking]] — evaluation method for autonomous research pipelines that benchmarks agent output against an already-published paper's own reported result as ground truth.
- [[replica-figure-replication-pipeline]] — automated task-generation method producing figure-replication benchmarks at the replication pipeline stage.
