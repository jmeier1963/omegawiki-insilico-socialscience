...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.7); proposed in: generative-agent-simulations-000-people'
origin_gaps: []
tags:
- generative-agents
- human-simulation
