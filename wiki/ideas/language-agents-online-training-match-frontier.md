...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.65); proposed in: aviary-training-language-agents-challenging-scientific'
origin_gaps: []
tags:
- language-agents
- scientific-tasks
