...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.75); proposed in: performance-large-language-model-reasoning-tasks, chatgpt-defeated-doctors-diagnosing'
origin_gaps: []
tags:
- llm-medicine
- clinical-reasoning
- diagnosis
- physician-ai-comparison
- o1
- emergency-medicine
domain: NLP
priority: 3
