...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.7); proposed in: human-study-did-involve-human-subjects, survey-response-generation-generating-closed-ended'
origin_gaps: []
tags:
- llm-validity
- behavioral-science
