...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.7); proposed in: synthetic-participants-generated-large-language-models'
origin_gaps: []
tags:
- silicon-sampling
