...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.6); proposed in: large-language-models-hack-rewards-society'
origin_gaps: []
tags:
- reward-hacking
