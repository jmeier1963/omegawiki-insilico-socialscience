...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.55); proposed in: agentsociety-large-scale-simulation-llm-driven, law-silico-simulating-legal-society-llm'
origin_gaps: []
tags:
- social-simulation
- large-scale
