...
status: validated
origin: 'Migrated from research claim (original status: supported, confidence: 0.8); proposed in: generative-agents-interactive-simulacra-human-behavior, generative-agent-simulations-000-people, agentsociety-large-scale-simulation-llm-driven, modeling-earth-scale-human-like-societies'
origin_gaps: []
tags:
- llm-agents
- social-simulation
