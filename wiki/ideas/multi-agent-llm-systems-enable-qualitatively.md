...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.4); proposed in: beyond-static-responses-multi-agent-llm, llm-agent-based-social-simulation-attitude'
origin_gaps: []
tags:
- multi-agent
- social-simulation
