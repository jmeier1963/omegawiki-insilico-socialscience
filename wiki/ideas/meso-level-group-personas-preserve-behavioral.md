...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.55); proposed in: synonymix-unified-group-personas-generative-simulations'
origin_gaps: []
tags:
- persona
- group-simulation
