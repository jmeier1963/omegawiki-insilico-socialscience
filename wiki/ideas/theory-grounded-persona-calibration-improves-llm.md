...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.65); proposed in: large-language-models-simulated-economic-agents, polypersona-persona-grounded-llm-synthetic-survey'
origin_gaps: []
tags:
- llm-simulation
