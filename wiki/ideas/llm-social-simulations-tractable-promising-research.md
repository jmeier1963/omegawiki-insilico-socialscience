...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.6); proposed in: position-llm-social-simulations-promising-research, large-language-models-computational-social-science, using-llms-advance-cognitive-science-collectives'
origin_gaps: []
tags:
- llm-simulation
- social-science
