...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.65); proposed in: generative-agent-based-modeling-actions-grounded, agentsociety-large-scale-simulation-llm-driven'
origin_gaps: []
tags:
- multi-agent
- social-simulation
