...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.72); proposed in: capacity-moral-self-correction-large-language'
origin_gaps: []
tags:
- alignment
- rlhf
