...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.65); proposed in: agentsocialbench-evaluating-privacy-risks-human-centered'
origin_gaps: []
tags:
- privacy
- multi-agent
