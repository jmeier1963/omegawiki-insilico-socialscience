...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.55); proposed in: deliberate-lab-platform-real-time-human'
origin_gaps: []
tags:
