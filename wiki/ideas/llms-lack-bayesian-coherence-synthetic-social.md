...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.65); proposed in: evaluating-use-large-language-models-synthetic'
origin_gaps: []
tags:
- llm-validity
- epistemology
