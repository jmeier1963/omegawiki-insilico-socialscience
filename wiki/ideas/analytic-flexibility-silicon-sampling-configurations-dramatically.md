...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.6); proposed in: threat-analytic-flexibility-using-large-language'
origin_gaps: []
tags:
- silicon-sampling
