...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.72); proposed in: advancing-mathematics-research-ai-driven-formal'
origin_gaps: []
tags:
- formal-proof
- lean
