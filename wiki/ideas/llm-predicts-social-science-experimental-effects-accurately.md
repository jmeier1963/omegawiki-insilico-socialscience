...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.75); proposed in: predicting-results-social-science-experiments-using'
origin_gaps: []
tags:
- silicon-sampling
- llm-simulation
