...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.7); proposed in: whose-personae-synthetic-persona-experiments-llm, prompt-perturbations-reveal-human-like-biases'
origin_gaps: []
tags:
- persona
- llm-alignment
