...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.6); proposed in: metagpt-meta-programming-multi-agent-collaborative'
origin_gaps: []
tags:
- multi-agent
- sop
