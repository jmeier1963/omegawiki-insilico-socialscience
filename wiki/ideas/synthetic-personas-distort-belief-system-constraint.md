...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.7); proposed in: synthetic-personas-distort-structure-human-belief'
origin_gaps: []
tags:
