...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.4); proposed in: automatize-scientific-discovery-cognitive-sciences'
origin_gaps: []
tags:
- automated-discovery
- cognitive-science
