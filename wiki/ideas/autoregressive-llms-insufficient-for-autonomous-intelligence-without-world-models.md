...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.5); proposed in: path-towards-autonomous-machine-intelligence'
origin_gaps: []
tags:
- agi
- world-model
