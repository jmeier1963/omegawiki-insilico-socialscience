...
status: validated
origin: 'Migrated from research claim (original status: supported, confidence: 0.85); proposed in: foundation-model-predict-capture-human-cognition'
origin_gaps: []
tags:
- foundation-model
- cognition
