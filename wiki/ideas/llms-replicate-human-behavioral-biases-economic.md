...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.75); proposed in: large-language-models-simulated-economic-agents, automated-social-science-language-models-scientist, modeling-earth-scale-human-like-societies'
origin_gaps: []
tags:
- llm-simulation
