...
status: proposed
origin: 'Migrated from research claim (original status: proposed, confidence: 0.6); proposed in: restoring-heterogeneity-llm-based-social-simulation'
origin_gaps: []
tags:
- silicon-sampling
- heterogeneity
