...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.65); proposed in: scaling-synthetic-data-creation-billion-personas'
origin_gaps: []
tags:
- synthetic-data
- persona
