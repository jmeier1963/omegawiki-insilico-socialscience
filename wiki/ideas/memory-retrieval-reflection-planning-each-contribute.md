...
status: validated
origin: 'Migrated from research claim (original status: supported, confidence: 0.85); proposed in: generative-agents-interactive-simulacra-human-behavior'
origin_gaps: []
tags:
- agents
- memory
