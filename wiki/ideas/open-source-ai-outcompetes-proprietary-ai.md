...
status: proposed
origin: 'Migrated from research claim (original status: weakly_supported, confidence: 0.55); proposed in: google-no-moat-open-source-ai, meta-open-source-llama-ai-decision'
origin_gaps: []
tags:
- open-source-ai
- proprietary-ai
